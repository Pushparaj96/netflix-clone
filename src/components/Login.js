...
const handleSignupClick = () => {
  ...
  return (
    <div className='login-background min-h-screen relative'>
        ...
        <Header/>
         <div className='relative md:pt-[12%] pt-[26%]'>
            <div className='bg-black text-white bg-opacity-65 p-8 rounded-xl w-10/12  md:w-5/12 lg:w-3/12 form-container mx-auto right-0 left-0'>
