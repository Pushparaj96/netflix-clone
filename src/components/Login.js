         ...
         <div className='relative h-full flex justify-center items-center'>
            <div className='bg-black text-white bg-opacity-60 p-8 rounded-xl w-3/12'>
                ...
                <form className='p-4'>
                    ...
                    <button className='bg-red-700 text-white rounded-lg py-1 px-4 font-semibold text-base hover:bg-white hover:text-red-800 transform transition-all duration-200 hover:scale-103'>Sign In</button>
                    </div>

                    <p className='pt-6 text-base font-medium'>New to Netflix? <span className='hover:underline cursor-pointer'>Sign up here !</span></p>
